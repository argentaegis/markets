"""Mock Strategizer HTTP for unit tests.

Returns deterministic signals matching strategizer service behavior
for buy_and_hold, covered_call, buy_and_hold_underlying, orb_5m, trend_entry_trailing_stop.

Use in unit tests only. Integration tests use the real strategizer service.
"""
...
def mock_strategizer_http():
    ...
    Use in unit tests. Integration tests use the real strategizer service.
    """
